...
class _BebidasPageState extends State<BebidasPage> {
  List<Item> burger= [
    const Item(nome: "Cerveja Artesanal",
        preco: 20,
    ...
    const Item(nome: "Cerveja",
        preco: 10,
        urlAvatar: "https://media.istockphoto.com/photos/alcoholic-drinks-picture-id816174634?k=20&m=816174634&s=612x612&w=0&h=KTanppG1bSlOoNe6U8ffi4xhekJebe02kiBKK_FzXQ4=",
        descricao: "",
        quantidade : 1,
    ),
    const Item(nome: "Água com gás e sem gás",
        preco: 4,
        urlAvatar: "https://media.istockphoto.com/photos/alcoholic-drinks-picture-id816174634?k=20&m=816174634&s=612x612&w=0&h=KTanppG1bSlOoNe6U8ffi4xhekJebe02kiBKK_FzXQ4=",
        descricao: "",
        quantidade : 1,
    ),
    const Item(nome: "Refigerante",
        preco: 6,
        urlAvatar: "https://media.istockphoto.com/photos/alcoholic-drinks-picture-id816174634?k=20&m=816174634&s=612x612&w=0&h=KTanppG1bSlOoNe6U8ffi4xhekJebe02kiBKK_FzXQ4=",
        descricao: "",
        quantidade : 1,
    ),
    const Item(nome: "Sucos",
      preco: 6,
      urlAvatar: "https://media.istockphoto.com/photos/alcoholic-drinks-picture-id816174634?k=20&m=816174634&s=612x612&w=0&h=KTanppG1bSlOoNe6U8ffi4xhekJebe02kiBKK_FzXQ4=",
      descricao: "",
      quantidade : 1,
    ),
    const Item(nome: "Drinks",
      preco: 18,
      urlAvatar: "https://media.istockphoto.com/photos/alcoholic-drinks-picture-id816174634?k=20&m=816174634&s=612x612&w=0&h=KTanppG1bSlOoNe6U8ffi4xhekJebe02kiBKK_FzXQ4=",
      descricao: "",
      quantidade : 1,
